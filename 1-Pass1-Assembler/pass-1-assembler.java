...
public class ass3 {
	...
	{
// Made a file in the project itself and imported it here rather than keeping it in the Desktop and then importing
		FileReader FP=new FileReader("input1.txt");
